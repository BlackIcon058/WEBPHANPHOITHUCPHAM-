                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{URL::to('/store-users-in-register-page')}}" method="post">
                                        {{ csrf_field() }}

                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="admin_name" id="" aria-describedby="" placeholder="Enter Name..." value="{{old('admin_name')}}">

                                        </div>

                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="admin_email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="admin_phone" id="" aria-describedby="" placeholder="Enter Phone..." value="{{old('admin_phone')}}">
                                        </div>
