            ...
            <div class="table-wrapper">
                <div class="table-title">
                        ...
                        <div class="col-sm-4">
                            <form action="{{ URL::to('/tim-kiem-binh-luan') }}" class="header_search" method="get">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Tìm kiếm theo nội dung hoặc username ..." name="keywords_submit">
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                            @foreach($search_comment as $key => $comm)
                            <tr>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="single-wrap d-flex justify-content-center">
                        {{ $search_comment->appends(['keywords_submit' => $keywords])->links() }}
                    </div>
                </div>
            </div>
        </div>
