                        ...
                        <div class="container">
                            ...
                            <div class="single-job-items mb-30">
                                ...
                                <div class="items-link items-link2 f-right">
                                    <a href="#">{{ \Carbon\Carbon::parse($bai->open_time_start)->format('H:i') }} - {{ \Carbon\Carbon::parse($bai->open_time_end)->format('H:i') }}
                                    </a>
                                    @php
                            ...
                            <!-- <div class="single-job-items mb-30">
                                <div class="job-items">
                                    ...
                                    <div class="job-tittle job-tittle2">
                                        <a href="#">
                                            <h4>Rau Củ Quả Hỏng</h4>
                                        </a>
                                        <ul>
                                            <li><a style="color: #908080;" href="{{URL::to('/shop-details')}}"><i class="fa-solid fa-store"></i>Nhà hàng 5 sao</a></li>
                                            <li><i class="fas fa-map-marker-alt"></i>Quận 8, HCM</li>
                                        </ul>
                                        <ul>
                                            <li><i class="fa-solid fa-weight-scale"></i>Còn lại: 7kg</li>
                                            <li style="margin-left: 15px;"><i class="fa-solid fa-money-check"></i>35000VNĐ</li>
                                        </ul>
                                        @if(Auth::check())

                                        <ul>
                                            <li>
                                                <a target="_blank" href="{{URL::to('/chatify/2')}}" style="color: #2C7865;"><i class="fa-brands fa-rocketchat"></i>Chat trực tiếp</a>
                                            </li>
                                            <li>
                                                <a href="#" style="color: #2C7865;"><i class="fa-solid fa-cart-shopping"></i>Đặt hàng</a>
                                            </li>
                                        </ul>
                            ...
                            <div class="single-job-items mb-30">
                                <div class="job-items">
                                    ...
                                    <div class="job-tittle job-tittle2">
                                        ...
                                        <ul>
                                            <li>
                                                <a onclick="alert('Vui lòng đăng nhập chat trực tiếp!')" href="{{URL::to('/login')}}" style="color: #2C7865;"><i class="fa-brands fa-rocketchat"></i>Chat trực tiếp</a>
                                            </li>
                                            <li>
                                                <a href="{{URL::to('/login')}}" onclick="alert('Vui lòng đăng nhập để thêm vào giỏ hàng!')" style="color: #2C7865;"><i class="fa-solid fa-cart-shopping"></i>Đặt hàng</a>
                                            </li>
