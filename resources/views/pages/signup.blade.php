        ...
        <section class="signup">
            ...
            <div class="container">
                ...
                <!-- <form method="post" class="my-login-validation" novalidate="" action="{{ URL::to('/add-customer') }}"> -->
                    ...
                    <form method="POST" id="signup-form" class="signup-form" action="{{ URL::to('/add-customer') }}">
                    {{csrf_field()}}
                        <h2 class="form-title">Create account</h2>
                        <div class="form-group">
                            <input type="text" class="form-input" name="customer_name" id="name" placeholder="Your Name" />
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-input" name="customer_email" id="email" placeholder="Your Email" />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="customer_password" id="password" placeholder="Password" />
                    ...
                    <p class="loginhere">
                        Have already an account ? <a href="{{URL::to('/login-customer')}}" class="loginhere-link">Login here</a>
                    </p>
                </div>
            </div>
        </section>
